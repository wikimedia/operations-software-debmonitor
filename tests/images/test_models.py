...
def test_image_str():
    ...
    image = models.Image.objects.get(name='parsoid')
    assert str(image) == 'parsoid'
...
def test_imagepackage_str_no_upgrade():
    ...
    package = models.ImagePackage.objects.get(image__name='parsoid', package__name='gcc-9')
    package_str = str(package)
    assert 'parsoid' in package_str
...
def test_imagepackage_str():
    """The string representation of an ImagePackage object should return its image, package and versions details."""
    package = models.ImagePackage.objects.get(image__name='parsoid', package__name='nodejs')
    package_str = str(package)
    assert 'parsoid' in package_str
...
def test_packageversion_wrong_pkg_os():
    ...
    image_package = models.ImagePackage.objects.get(image__name='parsoid', package__name='nodejs')
...
def test_packageversion_wrong_pkg():
    ...
    image_package = models.ImagePackage.objects.get(image__name='parsoid', package__name='gcc-9')
